...
const LESSON_TYPE_COLORS: Record<string, string> = {
  ...
  AUDIO: "bg-teal-500/10 text-teal-700 dark:text-teal-400 border-teal-500/20",
  PRESENTATION: "bg-orange-500/10 text-orange-700 dark:text-orange-400 border-orange-500/20",
  DOWNLOAD: "bg-slate-500/10 text-slate-700 dark:text-slate-400 border-slate-500/20",
  EMBED: "bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 border-indigo-500/20",
  ASSIGNMENT: "bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border-emerald-500/20",
  LIVE_SESSION: "bg-pink-500/10 text-pink-700 dark:text-pink-400 border-pink-500/20",
  SURVEY: "bg-cyan-500/10 text-cyan-700 dark:text-cyan-400 border-cyan-500/20",
  EBOOK: "bg-lime-500/10 text-lime-700 dark:text-lime-400 border-lime-500/20",
  DISCUSSION: "bg-fuchsia-500/10 text-fuchsia-700 dark:text-fuchsia-400 border-fuchsia-500/20",
  SCORM: "bg-yellow-500/10 text-yellow-700 dark:text-yellow-400 border-yellow-500/20",
};
